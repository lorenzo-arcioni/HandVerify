...
\begin{equation}
\mathbf{x}_1,\mathbf{x}_2\in\mathbb{R}^{D}
\end{equation}
...
\begin{equation}
\mathbf{e}_1=g_{\phi}(\mathbf{x}_1),
\qquad
\mathbf{e}_2=g_{\phi}(\mathbf{x}_2)
\end{equation}
...
\begin{equation}
\mathbf{z}_1,\mathbf{z}_2\in\mathbb{R}^{32},
\qquad
\|\mathbf{z}_1\|_2=\|\mathbf{z}_2\|_2=1
\end{equation}
...
s_{12}
=
\frac{\mathbf{z}_1^T\mathbf{z}_2}
...
\begin{equation}
s_{12}=\mathbf{z}_1^T\mathbf{z}_2
\end{equation}
