...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{images/distribution_images.png}
\\[0.5em]
...
Margin & 0.5 (Contrastive), 0.3 (Triplet) \\
Positive ratio & 0.5 \\
Dropout & 0.2 \\
Frozen encoder layers & 3 (Contrastive/Triplet), 0 (BCE) \\
Negative resampling & Every epoch (Triplet only) \\
