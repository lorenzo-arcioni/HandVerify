...
def create_contrastive_dataloaders_kfold(
    data_root: str,
    n_splits: int = 5,
    current_fold: int = 0,
    batch_size: int = 16,
    ...
    """
    Create train and test dataloaders for contrastive learning with K-Fold.
